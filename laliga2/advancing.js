...
fetch("combinedLL2.json")
  ...
  .then((data) => {
    ...
    const gamesToAnalyze = [
      ...
      {
        team1: "Villarreal B @ Home",
        team2: "Mirandes @ Away",
      },
      {
        team1: "Amorebieta @ Home",
        team2: "Oviedo @ Away",
      },
      {
        team1: "Tenerife @ Home",
      ...
      {
        team1: "Real Zaragoza @ Home",
        team2: "Eibar @ Away",
      },
      {
        team1: "Racing Ferrol @ Home",
        team2: "Eldense @ Away",
      },
      {
        team1: "Huesca @ Home",
      ...
      {
        team1: "Racing Santander @ Home",
        team2: "Burgos @ Away",
      },
      {
        team1: "Albacete Balompie @ Home",
        team2: "Sporting Gijon @ Away",
      },
      {
        team1: "Valladolid @ Home",
        team2: "FC Andorra @ Away",
      },
      {
        team1: "Alcorcon @ Home",
        team2: "FC Cartagena @ Away",
      },
      // Add more games here
    ];
    // Function to calculate the game sums
